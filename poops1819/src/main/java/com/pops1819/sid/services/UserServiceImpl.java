...
public class UserServiceImpl implements UserService {
	...
	public User createUser(UserRequest user) {
		...
		if(newUser.getStatus() == null)
			newUser.setStatus(USER_STATUS.Collaborator.toString());
		if(!newUser.getStatus().equals(USER_STATUS.Collaborator.toString()))
			return null;
		
		vacations.forEach(e -> balances.add(new Balance(e.getMaxDays(), e, newUser)));
